...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route("/why-account", get(handlers::public::why_account))
        ...
        .route("/api/user/article/{id}/like", post(handlers::user::like_article))
        .route("/api/user/article/{id}/unlike", post(handlers::user::unlike_article))
        .route("/api/user/article/{id}/read-later", post(handlers::user::mark_read_later))
        .route("/api/user/article/{id}/unread-later", post(handlers::user::unmark_read_later))
